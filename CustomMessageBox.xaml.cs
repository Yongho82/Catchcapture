        ...
        public static MessageBoxResult Show(string message, string? title = null, MessageBoxButton button = MessageBoxButton.OK, MessageBoxImage image = MessageBoxImage.None, double width = 0, string? yesLabel = null, string? noLabel = null, string? cancelLabel = null, string? okLabel = null, TextAlignment textAlignment = TextAlignment.Center)
        {
            ...
            switch (button)
            {
                case MessageBoxButton.OK:
                    ...
                    msgBox.BtnRight.Content = okLabel ?? LocalizationManager.GetString("BtnOK");
                ...
                case MessageBoxButton.OKCancel:
                    msgBox.BtnLeft.Content = cancelLabel ?? LocalizationManager.GetString("BtnCancel");
                ...
                case MessageBoxButton.YesNoCancel:
                    msgBox.BtnLeft.Content = noLabel ?? LocalizationManager.GetString("BtnNo");
                    msgBox.BtnLeft.Tag = MessageBoxResult.No;
                    
                    msgBox.BtnRight.Content = yesLabel ?? LocalizationManager.GetString("BtnYes");
